...
class CNNV2(nn.Module):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        # Batch Normalization
        self.batch_norm_base = nn.BatchNorm1d(hidden_size)
        
        # Hidden layer
        self.hidden = nn.Linear(species_size+stress_condition_size+cnn_filers, hidden_size)
    ...
    def forward(self, input):
        ...
        # Batch Normalization
        x_base = self.batch_norm_base(x_base)
