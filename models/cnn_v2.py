...
class CNNV2(nn.Module):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.bn_stress_condition = nn.BatchNorm1d(hidden_size)  # Batch normalization for stress condition
        ...
        self.bn_hidden = nn.BatchNorm1d(hidden_size)  # Batch normalization for hidden layer
    ...
    def forward(self, input):
        ...
        x_stress_condition = self.bn_stress_condition(x_stress_condition)  # Apply batch normalization
